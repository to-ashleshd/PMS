...
//        echo "</pre>";die();
        ...
        //Added By Ajay for Company Validataion
        $data['active_company_count'] = $this->companymodel->getActiveCompanyCount();
        //$data['']
...
//        echo "</pre>";die();
    ...
    public function old_updateofficetypestatus($office_type_id) {
        $data = array();
        $data['site_name'] = $this->generalesettings->getSiteName();
        $data['logo'] = $this->generalesettings->getImage();
