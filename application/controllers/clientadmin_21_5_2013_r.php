...
//        echo '</pre>';die();
    ...
    function dashboard() {
        if ($this->session->userdata('pms_employee_id')) {
            ...
            if(!empty($current_year_detail))
            {
                $data['display_current_year'] = '[ '.$current_year_detail['time_period_from'].'&mdash;'.$current_year_detail['time_period_to'].' ]';
            }
            ...
            {
                $data['display_immidiate_pre_year'] = '[ '.$immediate_previous_year_detail['time_period_from'].'&ndash;'.$immediate_previous_year_detail['time_period_to'].' ]';
            }
