    ...
    function addkradata() {
        ...
        if ($this->session->userdata('pms_employee_id')) {
            ...
            if (!empty($_POST)) {
                ...
                if ($result) {
                    echo "Apraisee Kra Submitted Successfully By Apraiser";
                } else {
    ...
    function addcompetencywithidp() {
        ...
        if ($this->session->userdata('pms_employee_id')) {
            ...
            if (!empty($_POST)) {
                ...
                $reviewer_kra_score = (($final_kra_score * 70) / 100);
                $reviewer_cwi_score = (($response['final_score_cwi'] * 30) / 100);
                $reviewer_total_score = (($reviewer_kra_score) + ($reviewer_cwi_score));
                ...
                if ($result == 1 && $result_technical == 1 && $result_behavioural == 1 && $result_overall_rating == 1) {
                    ...
                    echo "Competencies with IDP Submitted Successfully By Apraiser";
                } else {
                    echo "Please try again";
                }
            }
