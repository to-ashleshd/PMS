...
class Commonmodel extends CI_Model {
    ...
    function getDropDownSQL($country_id = '', $state_id = '') {
        $table_country = $this->db->coreprefix . 'countrymaster';
        $table_state = $this->db->coreprefix . 'statemaster';
        $table_city = $this->db->coreprefix . 'citymaster';
...
// echo "</pre>";
    ...
    function countryDropDown($default_id = '') {
        //$table_name = $this->db->coreprefix . 'countrymaster';
