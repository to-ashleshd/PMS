              ...
              <div class="row-fluid">
                <div class="tabbable tabbable-bordered">
                  <ul class="nav nav-tabs">
					...
					<li class="<?php echo ($tab == 'tb1_businesscompany'? 'active' : '') ?>" ><a data-toggle="tab" href="#tb1_businesscompany">Business Company</a></li>
				  ...
				  <!-- Tab Business -->
				  <div id="tb1_business" class="tab-pane <?php echo ($tab == 'tb1_h'? 'active' : '') ?>">
...
?>
                    ...
                    <div id="tb1_f" class="tab-pane <?php echo ($tab == 'tb1_f'? 'active' : '') ?>">
					  ...
					  <?php else: ?>
					  	<p class="heading_a">Please Create at least one company</p>
					  <?php endif; ?>
                    </div>
                    <!-- End Tab 6 -->
                    <!-- Tab 7 -->
