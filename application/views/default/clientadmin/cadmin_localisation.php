...
?>
                    ...
                    <div id="tb1_g" class="tab-pane <?php echo ($tab == 'tb1_g'? 'active' : '') ?>">
					  ...
					  <?php if( $active_company_count >= 1 ): ?>
                      <form action="<?php echo site_url($action); ?>" method="post" name="offiveadressmaster" >
...
-->
                        ...
                        <div class="span6">
                          <div class="formSep">
                            <label class="span4">Select City</label>
							<!-- Remove validation onchange="check_company_validation() -->
                            <select id="city_office_add" name="city_office_add" class="span5" >
                              <option value="">--Please Select--</option>
                              <?php
						  if(isset($city_master))
						  {
