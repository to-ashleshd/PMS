            ...
            <div class="container-fluid">
				...
				<tbody>
					...
					<tr>
					  ...
					  <td valign="top" style="text-align:left;"><span style="text-align:left;"><?php echo $top_employee_last_score; ?></span></td>
					</tr>
					<tr>
				...
				<!-- End New Table -->
                            ...
                            <div class="w-box-content cnt_b">
                                <div class="row-fluid">
									...
									?>
									<!--
									Overall KRA Score : <span id="show_overall_kra_score" style="font-weight:bold"><?php if(isset($overall_kra_score_name)){ echo $overall_kra_score.' - '.$overall_kra_score_name; }  ?></span>,									
									&nbsp;&nbsp;Overall Competencies Score : <span id="show_overall_comp_score" style="font-weight:bold"><?php if(isset($overall_comp_score_name)){ echo $overall_comp_score_name.' - '.$overall_kra_score_name; }  ?></span>,
									&nbsp;&nbsp;Total Score : <span id="show_overall_total_score" style="font-weight:bold"><?php if(isset($overall_total_score_name)){ echo $overall_total_score.' - '.$overall_kra_score_name; }  ?></span>
									-->
									<!-- Remove Score Name -->
									Overall KRA Score : <span id="show_overall_kra_score" style="font-weight:bold"><?php if(isset($overall_kra_score_name)){ echo $overall_kra_score; }  ?></span>,									
									&nbsp;&nbsp;Overall Competencies Score : <span id="show_overall_comp_score" style="font-weight:bold"><?php if(isset($overall_comp_score_name)){ echo $overall_comp_score_name.' - '.$overall_kra_score_name; }  ?></span>,
									&nbsp;&nbsp;Total Score : <span id="show_overall_total_score" style="font-weight:bold"><?php if(isset($overall_total_score_name)){ echo $overall_total_score.' - '.$overall_kra_score_name; }  ?></span>
               ...
               <?php
				  ...
				  ?>
					...
					<tr>
									...
									<td>&nbsp;</td>
									<td><span id="final_score"><?php if($final_score_cwi!='') { echo number_format($final_score_cwi, 2, '.', ''); } ?></span></td>
				   </tr>
				   </tbody>
					</table>
					</td>
					...
					data: {
							...
							success: function(response) {
								...
								if(response.kra_detail.length > 0 )
								{
									...
									$('#show_overall_comp_score').html('');
									$('#show_overall_total_score').html('');
									}
								}
...
var  final_score = '';
	$('#tbl_competencies tr').each(function() {
				...
				var overall_comp_score = ((parseFloat(final_score)*30)/100);
				var url = '<?php echo site_url("apraiser/ajax_get_score_name") ?>';
				 $.ajax({
					...
					type: 'POST',
					data: {
							overall_score : overall_comp_score
						  },
							success: function(response) {
									//$('#show_overall_comp_score').html(parseFloat(overall_comp_score).toFixed(2)+' - '+response.score_name);
									$('#show_overall_comp_score').html(parseFloat(overall_comp_score).toFixed(2)+' ');
							}
					});
					
					//for total score
					var final_kra_score = $('#final_kra_score').html();
					var overall_kra_score = ((parseFloat(final_kra_score)*70)/100);
					//alert(overall_kra_score);
					var total_score_to_show = parseFloat(overall_comp_score) + parseFloat(overall_kra_score); 
					...
					type: 'POST',
					data: {
							overall_score : total_score_to_show
						  },
							success: function(response) {
									$('#show_overall_total_score').html(parseFloat(total_score_to_show).toFixed(2)+' - '+response.score_name);
									//$('#show_overall_total_score').html(parseFloat(total_score_to_show).toFixed(2)+' ');
							}
					});
	...
	$('#apraiser_kra tr').each(function() {
				...
				var url = '<?php echo site_url("apraiser/ajax_get_score_name") ?>';
				 $.ajax({
					...
					type: 'POST',
					data: {
							overall_score : overall_kra_score
						  },
							success: function(response) {
									//$('#show_overall_kra_score').html(parseFloat(overall_kra_score).toFixed(2)+' - '+response.score_name);
									$('#show_overall_kra_score').html(parseFloat(overall_kra_score).toFixed(2)+' ');
							}
					});
...
//Default 
//calculate_total_score_per_row('rate_1');
//calculate_total();

function total_score_to_show()
{
	//Call for display purpose only
	//Recalculate
	var existing_kra = $("#show_overall_kra_score").html();
	var existing_kra = parseFloat(existing_kra).toFixed(2);


	var existing_comp = $("#show_overall_comp_score").html();
	existing_comp = parseFloat(existing_comp).toFixed(2);
	if( existing_comp == 'NaN' ) {
		existing_comp = 0;
	}

	var total_score_to_show = parseFloat(existing_comp) + parseFloat(existing_kra); 
	var url = '<?php echo site_url("apraiser/ajax_get_score_name") ?>';
