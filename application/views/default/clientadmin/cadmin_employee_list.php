									 ...
									 <tr>
										...
										<!--	<td><?php //echo $val['dummy_relation']?></td>-->
											 <td>
                                                <div class="btn-group">
<<<<<<< .mine
                                                    <a href="<?php echo site_url('employee/editemployee').'/'.$val['pms_employee_id']; ?>" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                   </div>
												    <div class="btn-group">
													<a href="<?php echo site_url('employee/viewemployee').'/'.$val['pms_employee_id']; ?>" class="btn btn-mini" title="View"><i class="icon-eye-open"></i></a>
