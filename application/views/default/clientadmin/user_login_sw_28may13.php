...
<div id="graybg" style="width:auto; height:500px; margin:auto; background-color:#f1f1f1;"  >
		<div id="left_info" style="margin-top: -134.5px; top: 35%; left:15%; position: absolute; clear:both;">
		<!-- <p class="heading_main2">PMS V 1.0</p> -->
		<!--
		<center><img src="<?php // echo base_url("assets/clientadmin/images/"); ?>/pms_1.png" /></center>
		-->
		<!--
		<p class="more_about">About PMS:
		This is used most often in the workplace, can apply wherever people interact schools, churches, community meetings, sports teams, health setting, governmental agencies,social events and even political settings - anywhere in the world people interact with their environments to produce desired effects.</p>
		-By Enrich
		-->
		<br />

		</div>
	<div id="rotatingbanner" style="width:375px; height:300px; position: absolute;top: 30%; left:5%;">
	<object classid"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="375" height="300"  >
      <param name="movie" value="<?php echo base_url("assets"); ?>/20.swf">
      <param name="quality" value="high">
	  <param name="wmode" value="transparent">
      <embed src="<?php echo base_url("assets"); ?>/20.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="375" height="300"></embed>
	  </object>
	  </div>
	
	<div id="login-wrapper"  style="margin-top: -134.5px; top: 50%; position: absolute; margin-left: -248px; left: 30%; clear:both">

  <div class="main-col" style=" border-left: 1px solid #C2C2C2;float: left;margin-left: 120px;padding: 10px 20px 10px 10px;position: relative;"> 
  
  	
	 
  <img src="<?php echo base_url("uploads"); ?>/<?php echo $mylogo; ?>" alt="" class="logo_img" style=" margin:-38px 0 0 -125px;position: absolute;top: 50%;width: 100px; height:auto;" />
	...
	<div class="login_links">
		...
		<a href="javascript:void(0)" id="pass_forgot"><span>Forgot password?</span></a> | <a href="javascript:void(0)" id="pass_login"><span>Account login</span></a>
