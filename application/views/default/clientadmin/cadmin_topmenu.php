    ...
    <div class="container-fluid">
      ...
      <div id="fade-menu" class="pull-left">
        ...
        <li><a href="javascript:void(0)">My KRA</a>
		  ...
		  ?>
		   <?php if($is_employee_apraiser=='Y' || $is_employee_reviewer=='Y') : ?>
		  ...
		  <?php if($is_employee_apraiser=='Y' || $is_employee_reviewer=='Y' || $in_authorization_matrix >= 1 ) :  ?>
		  <li><a href="javascript:void(0);">Reports</a>
					<ul>
						<!-- Display Report Dynamic -->
						<?php if(isset($all_time_periods)) : ?>
						<?php if(!empty($all_time_periods)) : ?>
						<?php foreach($all_time_periods as $key=>$val) : ?>
							...
							<li><a href="javascript:void(0);"> <?php echo $val['time_period_from'].' - '.$val['time_period_to']; ?></a>
								<ul>
									...
									<li><a href="<?php echo site_url('apraiser/statusreport').'/'.$val['time_period_id']; ?>">PMS Status Report</a></li>
									<?php // if ($this->session->userdata('email') == 'sharma.ashish@varrocgroup.com' ) : ?>
									...
									<li><a href="<?php echo site_url('reports/krastatusreport').'/'.$val['time_period_id']; ?>">KRA Status Report</a></li>
									<?php // endif; ?>
								</ul>
							</li>
							<?php endif; ?>
						<?php endforeach; ?>
						<!-- For fix issue next year -->
