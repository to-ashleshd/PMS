...
<script type="text/javascript">
//alert(document.getElementsByName('dt_colVis_Reorder_client_length').value);
var rowperpage = '<?php  echo $row_per_page; ?>';
//alert(rowperpage);
//$('select[name=\'dt_colVis_Reorder_client_length\']').val(rowperpage);
//alert(rowperpage);

//document.getElementsByName('dt_colVis_Reorder_client_length').value = rowperpage;

//dt_colVis_Reorder_client_length  
</script>dt_colVis_Reorder_client_length
