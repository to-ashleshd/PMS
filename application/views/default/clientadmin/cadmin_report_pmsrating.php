                                 ...
                                 <tbody>                                   
									...
									foreach($reviewer_employees as $key=>$val)
									{
										...
										**/
										...
										$pdf_link = site_url('mypdf/completereplort') .'/'. $val['pms_employee_id'] .'/'. $val['reviewer_employee_id'] .'/'.'1/pdf';
										$pdf_view_link = site_url('mypdf/completereplort') .'/'. $val['pms_employee_id'] .'/'. $val['reviewer_employee_id'] .'/'.'1/html';
										
										$kra_link = site_url('mypdf/pdfkra201314') .'/'. $val['pms_employee_id'] .'/2';
									...
									<tr>
										...
										<td><?php echo $reviewer_score_rating; ?> <a href='<?php echo $pdf_link;?>' target="_blank">PDF</a> | <a href='<?php echo $pdf_view_link;?>' target="_blank">View Online</a> | <a href="<?php echo $kra_link; ?>" target="_blank">KRA</a></td>
											<?php endif; ?>	
									</tr>
									<?php
										$counter++;
