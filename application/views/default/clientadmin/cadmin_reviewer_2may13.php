                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="tabbable tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                <li class="<?php echo ($tab == 'tb1_a'? 'active' : '') ?>"><a data-toggle="tab" href="#tb1_a">KRA</a></li>
                                                <li class="<?php echo ($tab == 'tb1_b'? 'active' : '') ?>"><a data-toggle="tab" href="#tb1_b">Competencies with IDP</a></li>
                                                <li class="<?php echo ($tab == 'tb1_c'? 'active' : '') ?>"><a data-toggle="tab" href="#tb1_c">Overall rating</a></li>
                                            </ul>
               ...
               <div class="row-fluid">
			   			  ...
			   			  <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center; font-size:12px;"><span><?php echo number_format($apraiser_overall_kra_score,'2','.',''); ?></span> <span data-placement="top" data-title="Weighted Score" data-content="((Total Final Rating Of KRA) *(70)) / 100" class="btn btn-mini pop-over" style="font-size:10px;" data-original-title="">&Sigma;</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-weight:bold;">Overall competencies Score</td>
                                                            <td style="text-align: center;">30%</td>
                                                            <td style="text-align: center; font-size:12px;"><span><?php echo number_format($apraiser_overall_competencies_score,'2','.',''); ?></span> <span data-placement="bottom" data-title="Weighted Score" data-content="((Total Final Rating Of Competencies) *(30)) / 100" class="btn btn-mini pop-over" style="font-size:10px;" data-original-title="">&Sigma;</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="font-weight:bold;">Overall Performance Score</td>
                                                            <td style="text-align: center; font-size:12px;"><span ><?php echo number_format($apraiser_overall_performance_score,'2','.',''); ?></span>
															</td>
                                                        </tr>
                  ...
                  <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="font-weight:bold;">Overall Performance Score</td>
                                                            <td style="text-align: center; font-size:12px;"><span id="overall_performance_score"><?php  if(!empty($overall_performance_score)) { echo  number_format($overall_performance_score,'2','.',''); } ?></span>
															</td>
                                                        </tr>
						 ...
						 <br />
						   <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td ><?php echo $apraiser_overall_performance_score_name; ?></td>
                                                            <!--<td>FEE</td>-->
