    ...
    <div class="row-fluid">
	 ...
	 ?>
      ...
      <div class="w-box-header">
			...
			<?php if( $track_status >= 0.2 ) : ?>
			<div style="width:20px; height:20px; float:right; margin-top:-7px;"><a href="<?php echo site_url("mypdf/pdfaddkra/") . '/'.$segment_3; ?>" target="_blank" ><i class="icsw16-pdf-documents icsw16-white" title="Print PDF"></i></a></div>
			<?php endif; ?>
...
$(document).ready(function() {
    ...
    $("#add_kra").submit(function() {
	 ...
	 else if(parseInt(used_kra)==6 && parseInt(new_weight) < parseInt(txt_edit_max_weight))
	 {
