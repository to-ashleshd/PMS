                    ...
                    <div class="span12">
						<!-------------------------------- Start KRA Approvel List   ------------------------------------------------------------------------>			
                            ...
                            <div class="w-box-content">
							    ...
							    <table id="dt_colVis_Reorder_k" class="table table-striped table-condensed">
                                <thead>									
									<tr>
                            ...
                            <div class="w-box-content">
                                ...
                                <thead>
                                 ...
                                 <tbody>
									...
									elseif($val['submit_status']>=6 && $val['submit_status'] < 7)
									{
									...
									elseif($val['submit_status']>=7 && $val['submit_status'] < 8)
									{
									$show_status  = get_pms_status($val['submit_status']) . ' ';
									$show_status .= '  -   <a href="'.base_url('reviewer/apraiseeassessment').'/'.$val['pms_employee_id'].'">'.'Reject</a>';
									}
	...
	$.msgBox({ type: "prompt",
                ...
                success: function (result, values) {
					...
					if( result == 'I Agree' ) {
						...
						var url = '<?php echo site_url("reviewer/addreviewerassessmentiagree"); ?>';
									var html = '';
									$.ajax({
										url: url,
										dataType: 'json',
...
<script type="text/javascript">
	if($('#dt_colVis_Reorder_r').length) {
		$('#dt_colVis_Reorder_r').dataTable({
	...
	if($('#dt_colVis_Reorder_k').length) {
		$('#dt_colVis_Reorder_k').dataTable({
			"sPaginationType": "bootstrap",
			"sDom": "R<'dt-top-row'Clf>r<'dt-wrapper't><'dt-row dt-bottom-row'<'row-fluid'ip>",
			"fnInitComplete": function(oSettings, json) {
				$('.ColVis_Button').addClass('btn btn-mini btn-inverse').html('Columns');
